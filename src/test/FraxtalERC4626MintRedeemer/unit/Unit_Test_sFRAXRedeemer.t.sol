...
import { UpgradeSfraxMintRedeemer } from "src/script/UpgradeSfraxMintRedeemer.s.sol";
import { Proxy } from "src/contracts/misc/Proxy.sol";
...
contract Unit_Test_sFRAXRedeemer is BaseTestMisc {
    ...
    function test_mdwrComboView() public {
        ...
        ) = sfraxMintRedeemer.mdwrComboView();
        ...
        (_maxAssetsDepositable, _maxSharesMintable, _maxAssetsWithdrawable, _maxSharesRedeemable) = sfraxMintRedeemer
            .mdwrComboView();

        // Check
        assertEq(
            _maxAssetsDepositable,
            Math.mulDiv(1040e18, 1e18, (1e18 - fee), Math.Rounding.Up),
            "[MDWR]: Final _maxAssetsDepositable"
        );
    ...
    function test_Mint() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FraxtalERC4626MintRedeemer.ERC4626ExceededMaxMint.selector, bob, 5e18, _max)
        );
    ...
    function test_Deposit() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FraxtalERC4626MintRedeemer.ERC4626ExceededMaxDeposit.selector, bob, 10e18, _max)
        );
    ...
    function test_Redeem() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FraxtalERC4626MintRedeemer.ERC4626ExceededMaxRedeem.selector, bob, 5e18, _max)
        );
    ...
    function test_Withdraw() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(FraxtalERC4626MintRedeemer.ERC4626ExceededMaxWithdraw.selector, bob, 5e18, _max)
        );
    ...
    function test_priceCannotChangeInterBlock() public {
        ...
        assertEq({
            a: minted_front,
            b: minted_back,
            err: "// NOTICE: User should not be able to front and back run oracle update"
        });
    }
    ...
    function test_feeOn_Withdraw() public {
        ...
        uint256 sharedIn = Math.mulDiv(
            assetOutWithFee,
            1e18,
            sfraxMintRedeemer.getVaultTknPriceStoredE18(),
            Math.Rounding.Up
        );
